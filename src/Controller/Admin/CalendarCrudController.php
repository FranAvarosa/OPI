    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ChoiceField::new('category', 'Categorie')->setChoices([
                ...
                'Formation' => 'Formation',
                'Coordination et préparation' => 'Coordination et préparation',
                'Action Institution et partenariat' => 'Action Institution et partenariat',
                'Animation éducative et sociale' => 'Animation éducative et sociale',
                'Travail de rue' => 'Travail de rue',
                'Présence sociale' => 'Présence sociale',
                'Présence sociale hors local' => 'Présence sociale hors local',
            ]),
