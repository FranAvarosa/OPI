 ...
 */
final class Version20220311085450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD service VARCHAR(100) DEFAULT NULL, DROP service1, DROP service2');
    }
