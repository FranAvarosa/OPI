 ...
 */
final class Version20220307093104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calendar DROP date_diff');
